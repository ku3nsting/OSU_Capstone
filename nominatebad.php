		...
		<div id="nomination">
			...
			<form method="post" action="sendAward.php">
				<div  id="nominationForm">
					...
					<select name="empID">
					<?php
					if(!($stmt = $mysqli->prepare("SELECT id, fname, lname, email FROM Employees"))){
					...
					if(!$stmt->bind_result($empID, $fname, $lname, $email)){
					...
					<div>
						<input type="radio" name="awardType" value="1";"checked>Employee of the Week <a href="/pdf/week.pdf">(preview pdf)</a><br>
